...
public class m_UserController {
	...
	public String postUserJoin(UserVO userVO) throws Exception {
		...
		//�α��� ȭ������
		return "redirect:/m/user/LoginForm";
	}
	...
	//맞춤모집정보 리스트로 이동하도록 수정필요@@@
		        ...
		        return "redirect:/m/user/LoginForm"; // 로그인 폼으로 다시 가도록 함
		    }
		...
		public ModelAndView logout(HttpSession session) {
			  ...
			  ModelAndView mav = new ModelAndView("redirect:/m/board/list");
		        return mav;
		}
