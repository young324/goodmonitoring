...
<body>
	...
	<!-- 게시판 -->
	<form name="insert" method="post" action="/m/user/userJoin">
		<table class="table table-borderless">
			<thead>
				<tr>
					<th style="background-color: #eeeeee; text-align: center;">개인
						회원가입</th>
				</tr>
			</thead>
			<tbody>
					...
					<td>  
						<div class="form-group">
							<label>아이디</label><input class="form-control" type="text"
								name="USR_ID"  style="margin-bottom:10px;"> <input type="button" name="id_check"
								placeholder="아이디를 입력해주세요" value="아이디 중복 확인">
							<!-- <small
						...
						<div class="form-group">
							<label>비밀번호</label> <input type="password" class="form-control"
								placeholder="비밀번호를 입력해주세요" name="USR_PASS" maxlength="50" /> <small
						...
						<div class="form-group">
							<label>이름</label> <input type="text" name="USR_NAME"
						...
						<div class="form-group">
							...
							<div class='input-group date dateTimePicker' id="datepicker1">
								<input type='text' class="form-control dtPicker"
									name="USR_BIRTH" required="required" /> <span
						...
						<div class="form-group">
							...
							<div>
								<div class="radio radio-info radio-inline">
									<input type="radio" id="male" value="남" name="USR_SEX"
										checked=""> <label for="male">남자</label>
								</div>
								<div class="radio radio-info radio-inline">
									<input type="radio" id="female" value="여" name="USR_SEX"
						...
						<div class="form-group">
							<label>핸드폰 번호</label> <input type="text" class="form-control"
								size="11px" maxlength="11" name="USR_TEL">
						</div>

						<div class="form-group">
							<label>이메일</label> <input type='text' name="USR_EMAIL"
								class="form-control">
						</div>
 
						<div class="form-group"> 
							<label>우편번호</label> <input type='text' name="USR_ZIPCODE"
								class="form-control">
						</div>
						<div class="form-group">
							<label>주소</label> <input type="text" name="USR_ADDR"
								class="form-control">
						</div>
						<div class="form-group">
							<label>소속</label> <select name="TARGET" id="Target"
								class="form-control">
						...
						<div class="form-group">
							<label>관심 모집업종</label> <br> <input type='checkbox'
								name="INTEREST_CATEGORY" value="11">가전,IT,에너지,자동차,그룹사<br>
							<input type='checkbox' name="INTEREST_CATEGORY" value="12">생활용품
							기업<br> <input type='checkbox' name="INTEREST_CATEGORY"
								value="13">식품관련 기업<br> <input type='checkbox'
								name="INTEREST_CATEGORY" value="14">육아전문 기업<br> <input
								type='checkbox' name="INTEREST_CATEGORY" value="15">주택,건설,인테리어<br>
							<input type='checkbox' name="INTEREST_CATEGORY" value="16">패션/메이크업
							기업<br> <input type='checkbox' name="INTEREST_CATEGORY"
								value="17">교육,문화 도서 출판<br> <input type='checkbox'
								name="INTEREST_CATEGORY" value="18">금융,보험<br> <input
								type='checkbox' name="INTEREST_CATEGORY" value="19">여가,건강,스포츠<br>
							<input type='checkbox' name="INTEREST_CATEGORY" value="20">방송,언론,교통,통신<br>
							<input type='checkbox' name="INTEREST_CATEGORY" value="21">유통,백화점,온라인
							쇼핑몰<br> <input type='checkbox' name="INTEREST_CATEGORY"
								value="22">행정기관, 지자체, 공공기관, NGO
						</div>
						<div class="form-group">    
							<label>경력 / 활동 기간</label><br> 
							<select name="USR_CAREER" class="form-control" style="margin-bottom:10px;">
								<option value="없음">없음</option>
								<option value="모니터링">모니터링</option>
								<option value="서포터즈">서포터즈</option>
								<option value="기자단">기자단</option>
							</select> <select name="USR_CAREER_DATE" class="form-control" style="margin-bottom:10px;">
								<option value="없음">없음</option>
							...
							</select><input type="button" name="careeradd" value="경력 추가">
						</div>
						<div class="form-group">
							<label>보유계정</label> <br> <input type='checkbox'
								name="ONLINE" value="블로그">블로그<br> <input
								type='checkbox' name="ONLINE" value="카페">카페<br> <input
								type='checkbox' name="ONLINE" value="트위터">트위터<br> <input
								type='checkbox' name="ONLINE" value="페이스북">페이스북<br>
							<input type='checkbox' name="ONLINE" value="인스타그램">인스타그램<br>
							<input type='checkbox' name="ONLINE" value="유튜브">유튜브<br>
							<input type='checkbox' name="ONLINE" value="카카오스토리">카카오스토리<br>
							<input type='checkbox' name="ONLINE">기타 <input
								type='text' name="ONLINE">
						</div>

						<div class="form-group"> 
							<label>계정 주소</label> <input type='text' name="ONLINE_URL"
								class="form-control"  style="margin-bottom:10px;"> <input type="button" name="adds"
								value="추가">
						</div>
					</td>
				</tr>
