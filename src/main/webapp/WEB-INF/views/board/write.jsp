			...
			<form role="form" action="/board/write" method="post">
						...
						<tr>
							...
							<td class="pull-left">
								<div class="control-group">
									<div class="controls">
										<select name="INTEREST_CATEGORY" id="IndustryCategory"
											class="form-control">
											<c:forEach items="${listIndustryCategory}"
												var="industrycategory">
												<option value="${industrycategory.INTEREST_CATEGORY}">${industrycategory.INTEREST_CATEGORY}</option>
											</c:forEach>
										</select>
									</div>
								</div>
				...
				<table class="table table-borderless"
					...
					<tbody>
									...
									<div class="col-sm-9">
										...
										<div class='col-sm-5'>
											<div class="form-group">
												<div class='input-group date dateTimePicker'
													id="datepicker1">
													<input type='date' class="form-control" name="AD_END_DATE"
						...
						<tr>
							<td>첨부파일</td>
							<!--<td><input type="file" id="afile" name="FILE_NAME"
